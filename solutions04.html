	...
	<div class="container">
        ...
        <!-- end section-title -->
			...
			<div class="content-box">
				...
				<h5>A business plan is a written document that describes </h5>
